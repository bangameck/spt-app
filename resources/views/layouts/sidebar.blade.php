            ...
            <ul class="admin-menu hs-accordion-group flex w-full flex-col gap-1">
                    ...
                    @if (Auth::user()->isAdmin() || Auth::user()->isFieldCoordinator())
                        <li class="menu-item">
                            <a class="group flex items-center gap-x-3.5 rounded-md px-3 py-2 text-sm font-medium text-default-600"
                                ...
                                <i class="i-lucide-user-check size-5"></i><span class="menu-text"> Kelola Koordinator
                                </span>
                            </a>
                        </li>
                        <li class="menu-item">
                ...
                @auth
                    ...
                    @if (Auth::user()->isAdmin())
                        ...
                        {{-- ✅ MENU BARU REKENING BLUD --}}
                        <li class="menu-item">
                            <a class="group flex items-center gap-x-3.5 rounded-md px-3 py-2 text-sm font-medium text-default-600"
                                href="{{ route('admin.blud-bank-accounts.index') }}">
                                <i class="i-lucide-landmark size-5"></i>
                                <span class="menu-text"> Rekening BLUD </span>
                            </a>
                        </li>
                    @endif
                @endauth
