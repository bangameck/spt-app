...
@section('content')
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        <h4 class="fw-bold mb-0">Tambah Ruas Jalan Baru</h4>
        ...
        <div class="card-body">
            <form action="{{ route('masterdata.road-sections.store') }}" method="POST">
                        ...
                        <div class="d-flex pt-2">
                            <div class="form-check me-4">
                                <input name="zone" class="form-check-input" type="radio" value="Zona 2" id="zone2"
                                    {{ old('zone', 'Zona 2') == 'Zona 2' ? 'checked' : '' }} />
                ...
                <div class="pt-6 text-end">
                    ...
                    <button type="submit" class="btn btn-primary">Simpan Ruas Jalan</button>
                </div>
            </form>
        </div>
    </div>
