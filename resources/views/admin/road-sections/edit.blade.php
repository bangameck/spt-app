...
@section('content')
    <div class="container-fluid">
        <div class="flex justify-between items-center mb-6">
            <h4 class="text-default-900 text-2xl font-bold">Edit Ruas Jalan: {{ $roadSection->name }}</h4>
        ...
        <div class="card bg-white shadow rounded-lg p-6">
            <form action="{{ route('masterdata.road-sections.update', $roadSection) }}" method="POST">
                @csrf
                ...
                <div class="mb-6">
                    ...
                    <input type="text" name="name" id="name"
                        ...
                        value="{{ old('name', $roadSection->name) }}" placeholder="Contoh: Jl. Sudirman" required>
                    @error('name')
