        ...
        <div class="container">
            <div class="content">
                ...
                <p>Pada hari ini {{ $agreement->signed_date->translatedFormat('l') }} tanggal
                    {{ Carbon\Carbon::parse($agreement->signed_date)->isoFormat('D MMMM YYYY') }}, Kami yang bertanda
                ...
                <table class="no-border">
                    ...
                    <tr>
                        ...
                        <td>Alamat</td>
                        <td>:</td>
                        <td>Jl. Abdul Rahman hamid Komp. Perkantoran tenayan raya Gedung B9 Lt. I dan II Kec. Tenayan
                            Raya</td>
                    </tr>
                    <tr>
                        <td></td>
                ...
                <table class="no-border" style="margin-top: 15px;">
                    ...
                    <tr>
                        <td></td>
                        <td colspan="3">Bertindak dalam jabatannya tersebut, untuk dan atas nama berkedudukan sebagai
                ...
                <p class="paragraph">Bahwa untuk mengoptimalkan pelayanan parkir di dalam ruang milik jalan dalam
                    wilayah Kota Pekanbaru, PIHAK PERTAMA bermaksud untuk melakukan kerjasama Pengelolaan Perparkiran di
                    Kota Pekanbaru.</p>
                <p class="paragraph">Bahwa PIHAK KEDUA merupakan Mitra Kerjasama Pengelolaan Perparkiran dan bermaksud
                ...
                <ol class="indent">
                    <li class="list-item">Pengelolaan manajemen dan kegiatan layanan parkir di dalam ruang milik jalan
                ...
                <p class="paragraph">Pendapatan layanan parkir sebagaimana yang sudah ditetapkan dan tertuang didalam
                    ...
                    _______________ (BRI) atas nama BLUD PERPARKIRAN KOTA PEKANBARU dan bukti penyetoran disampaikan ke
                ...
                <p class="paragraph">Apabila terjadi keterlambatan penyetoran/kekurangan penyetoran maka PIHAK PERTAMA
                    berhak melakukan pemotongan uang jaminan secara sepihak sebesar kekurangan setoran yang ditetapkan
                ...
                <p class="paragraph">Apabila PIHAK KEDUA tidak menyetorkan kewajiban 3 hari berturut-turut pertama maka
                    PIHAK PERTAMA memberikan surat teguran tertulis I dan di ikuti penarikan setoran, selanjutnya dalam
                    3 hari berturut-turut kedua masih juga tidak dilakukan penyetoran maka dapat diberikan surat teguran
                ...
                <p class="paragraph">Dalam hal PIHAK KEDUA telah melakukan penyetoran kewajiban dalam jangka waktu 6
                    ...
                    sendirinya;</p>
                <p class="paragraph">Selanjutnya PIHAK KEDUA telah melakukan penyetoran kewajiban dalam jangka waktu 2
                    (dua) minggu berturut-turut dengan lancar maka surat teguran II dinyatakan gugur dengan sendirinya.
                </p>
                ...
                <ol class="indent">
                    <li class="list-item">Memperoleh setoran tarif layanan parkir sebesar : Rp.
                        ...
                        /hari.</li>
                    <li class="list-item">Melakukan pengawasan langsung atas pengelolaan dan pelayanan perparkiran yang
                        dilaksanakan oleh PIHAK KEDUA;</li>
                    <li class="list-item">Memutuskan Kontrak Kerjasama ini apabila PIHAK KEDUA dianggap tidak cakap dan
                        dalam penilaian maka PIHAK PERTAMA kerjasama oprasional perparkiran tidak dapat dilaksanakan.
                    </li>
                </ol>
                <p class="paragraph">PIHAK PERTAMA berkewajiban :</p>
                <ol class="indent">
                    <li class="list-item">Menentukan dan menetapkan wilayah parkir yang akan dikelola oleh PIHAK KEDUA;
                    </li>
                    <li class="list-item">Memberikan data wilayah parkir yang akan dikelola oleh PIHAK KEDUA untuk dapat
                ...
                <ol class="indent">
                    <li class="list-item">Melaksanakan tugas pengelolaan parkir sesuai Peraturan Perundang – undangan
                        yang berlaku;</li>
                    ...
                    <li class="list-item">Memberikan sosialisasi dan pembekalan kepada juru parkir tentang Jasa Layanan
                        Parkir;</li>
                    <li class="list-item">Menyediakan fasilitas pembayaran non tunai (cashless) seperti
                        e-ticket/e-payment/e-money/QRIS sesuai dengan kebutuhan untuk kelancaran pelaksanaan pengelola
                        parkir secara profesional;</li>
                    <li class="list-item">Berkoordinasi dan melaporkan hasil pelaksanaan tugas kepada UPT Perparkiran
                        secara berkala;</li>
                    <li class="list-item">PIHAK KEDUA diwajibkan untuk melaporkan setiap penambahan potensi dan titik
                        lokasi parkir yang berlaku.</li>
                </ol>

                <p class="section-title">Pasal 7<br>Tarif Parkir</p>
                <p class="paragraph">PIHAK KEDUA memungut besaran tarif layanan parkir berdasarkan tarif layanan parkir
                ...
                <p class="paragraph">Pendapatan yang diperoleh PIHAK KEDUA dari tarif layananparkirwajib disetorkan
                    kepada PIHAK PERTAMA secara non tunai melalui bendaraha penerimaan sebagaimana diatur dalam pasal 4
                    ayat (1);</p>
                <p class="paragraph">Apabila terjadi perubahan penambahan potensi pendapatan layanan parkir maka PARA
                ...
                <p class="paragraph">Dalam rangka pelaksanaan Perjanjian Kerjasama ini akan dilakukan koordinasi antara
                    PARA PIHAK paling kurang 1 (satu) minggu sekali dan/atau pada waktu tertentu yang disepakati oleh
                    PARA PIHAK;</p>
                ...
                <p class="paragraph">Keadaan memaksa ( force majeure ) adalah keadaan yang terjadi diluar jangkauan dan
                    ...
                    banjir, gempa bumi, tsunami yang mengakibatkan keterlambatan atau kegagalan salah satu Pihak dalam
                    memenuhi kewajibannya sebagaimana tercantum dalam Perjanjian Kerjasama ini;</p>
                <p class="paragraph">Apabila terjadi force majeure sebagaimana dimaksud pada ayat (1) pasal ini maka
                ...
                <ol class="indent">
                    ...
                    <li class="list-item">PIHAK KEDUA tidak dibenarkan mengelola dan memungut jasa layanan perparkiran
                ...
                <p class="paragraph">Dalam hal PIHAK KEDUA melanggar ketentuan sebagaimana dimaksud dalam Pasal 14
                    huruf a, maka PIHAK KEDUA dikenakan sanksi dan ketentuan peraturan perundang-undangan yang berlaku;
                </p>
                ...
                <p class="paragraph">Pemutusan Perjanjian Kerjasama sebagaimana dimaksud ayat (1) huruf b, dilakukan
                    oleh PIHAK KEDUA dalam hal PIHAK PERTAMA tidak dapat melaksanakan kewajiban sebagaimana diatur dalam
                ...
                <p class="paragraph">Segala perbedaan pendapat atau perselisihan yang timbul dalam Perjanjian Kerjasama
                    ini akan diselesaikan secara musyawarah dan mufakat oleh PARA PIHAK;</p>

                <p class="section-title">Pasal 17<br>Lain-lain</p>
                <p class="paragraph">Segala sesuatu yang belum atau tidak cukup diatur dalam Perjanjian Kerjasama ini
                    akan dituangkan dalam suatu perjanjian tambahan (addendum) tersendiri yang merupakan satu kesatuan
                    yang tidak dapat terpisahkan dengan Perjanjian Kerjasama ini dan mempunyai kekuatan hukum yang sama;
                </p>
                ...
                <p class="paragraph">Demikian Perjanjian Kerjasama ini dibuat dan ditandatangani di Pekanbaru pada hari
                    dan tanggal tersebut di atas dalam rangkap 2 (dua) bermaterai cukup,masing-masing mempunyai kekuatan
                    hukum yang sama.</p>
